...
# Folder ka naam PritiMusic hi rakha hai
from PritiMusic import app, userbot
from PritiMusic.core.call import Lucky  # Call variable Lucky hai
...
# 🔥 CHANGED HERE - Main bot ke liye wapas @app kar diya gaya hai
