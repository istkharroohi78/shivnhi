...
# Yahan hum styled_button aur ButtonStyle import kar rahe hain
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        # Styled the Resume & Replay buttons
        buttons = [
            [
                styled_button(
        ...
        # Styled the Skip, Stop & Pause buttons
        buttons_resume = [
            [
                styled_button(
